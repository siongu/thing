...
public class BleScanRuleConfig {
    ...
    public static class Builder {
        ...
        void applyConfig(com.clj.fastble.scan.BleScanRuleConfig config) {
        ...
        public com.clj.fastble.scan.BleScanRuleConfig build() {
            com.clj.fastble.scan.BleScanRuleConfig config = new com.clj.fastble.scan.BleScanRuleConfig();
            applyConfig(config);
            return config;
        }
