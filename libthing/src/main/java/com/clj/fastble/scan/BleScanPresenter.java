...
public abstract class BleScanPresenter implements BluetoothAdapter.LeScanCallback {
    ...
    private static final class ScanHandler extends Handler {
        ...
        private final WeakReference<com.clj.fastble.scan.BleScanPresenter> mBleScanPresenter;

        ScanHandler(Looper looper, com.clj.fastble.scan.BleScanPresenter bleScanPresenter) {
            super(looper);
        ...
        public void handleMessage(Message msg) {
            com.clj.fastble.scan.BleScanPresenter bleScanPresenter = mBleScanPresenter.get();
    ...
    public void prepare(String[] names, String mac, boolean fuzzy, boolean needConnect,
        ...
        mHandlerThread = new HandlerThread(com.clj.fastble.scan.BleScanPresenter.class.getSimpleName());
