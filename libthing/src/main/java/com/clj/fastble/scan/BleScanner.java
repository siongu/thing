...
public class BleScanner {
    ...
    public static com.clj.fastble.scan.BleScanner getInstance() {
        return BleScannerHolder.sBleScanner;
    }

    private static class BleScannerHolder {
        private static final com.clj.fastble.scan.BleScanner sBleScanner = new com.clj.fastble.scan.BleScanner();
    }
