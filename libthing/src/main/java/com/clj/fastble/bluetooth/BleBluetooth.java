...
public class BleBluetooth {
    ...
    public synchronized BluetoothGatt connect(BleDevice bleDevice,
        ...
        if (bluetoothGatt != null) {
            ...
            BleManager.getInstance().getMultipleBluetoothController().removeConnectingBle(com.clj.fastble.bluetooth.BleBluetooth.this);
            if (bleGattCallback != null)
                bleGattCallback.onConnectFail(bleDevice, null, new OtherException("GATT connect exception occurred!"));
            ...
            switch (msg.what) {
                case BleMsg.MSG_CONNECT_FAIL: {
                    ...
                    if (connectRetryCount < BleManager.getInstance().getReConnectCount()) {
                        ...
                        if (bleGattCallback != null)
                            bleGattCallback.onConnectFail(bleDevice, bluetoothGatt, new ConnectException(bluetoothGatt, status));
                    }
                }
                break;
                ...
                case BleMsg.MSG_DISCONNECTED: {
                    ...
                    BleManager.getInstance().getMultipleBluetoothController().removeBleBluetooth(com.clj.fastble.bluetooth.BleBluetooth.this);
                ...
                case BleMsg.MSG_CONNECT_OVER_TIME: {
                    ...
                    if (bleGattCallback != null)
                        bleGattCallback.onConnectFail(bleDevice, bluetoothGatt, new TimeoutException());
                }
                break;
                ...
                case BleMsg.MSG_DISCOVER_FAIL: {
                    ...
                    if (bleGattCallback != null)
                        bleGattCallback.onConnectFail(bleDevice, bluetoothGatt,
                ...
                case BleMsg.MSG_DISCOVER_SUCCESS: {
                    ...
                    BleManager.getInstance().getMultipleBluetoothController().removeConnectingBle(com.clj.fastble.bluetooth.BleBluetooth.this);
                    BleManager.getInstance().getMultipleBluetoothController().addBleBluetooth(com.clj.fastble.bluetooth.BleBluetooth.this);
