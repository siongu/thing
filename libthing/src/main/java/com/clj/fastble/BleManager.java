...
public class BleManager {
    ...
    private static class BleManagerHolder {
        private static final com.clj.fastble.BleManager sBleManager = new com.clj.fastble.BleManager();
    }
     ...
     * @return BleManager
     */
    public com.clj.fastble.BleManager setMaxConnectCount(int count) {
     ...
     * @return BleManager
     */
    public com.clj.fastble.BleManager setOperateTimeout(int count) {
     ...
     * @return BleManager
     */
    public com.clj.fastble.BleManager setReConnectCount(int count) {
     ...
     * @return BleManager
     */
    public com.clj.fastble.BleManager setReConnectCount(int count, long interval) {
        if (count > 10)
            count = 10;
        if (interval < 0)
            interval = 0;
     ...
     * @return BleManager
     */
    public com.clj.fastble.BleManager setSplitWriteNum(int num) {
        if (num > 0) {
     ...
     * @return BleManager
     */
    public com.clj.fastble.BleManager setConnectOverTime(long time) {
        if (time <= 0) {
            time = 100;
        }
     ...
     * @return BleManager
     */
    public com.clj.fastble.BleManager enableLog(boolean enable) {
    ...
    public BluetoothGatt connect(BleDevice bleDevice, BleGattCallback bleGattCallback) {
        ...
        if (!isBlueEnable()) {
            BleLog.e("Bluetooth not enable!");
            bleGattCallback.onConnectFail(bleDevice, gatt, new OtherException("Bluetooth not enable!"));
            return null;
        }
        ...
        if (bleDevice == null || bleDevice.getDevice() == null) {
            bleGattCallback.onConnectFail(bleDevice, gatt, new OtherException("Not Found Device Exception Occurred!"));
        } else {
    ...
    public boolean write(BleDevice bleDevice,
        ...
        BleBluetooth bleBluetooth = multipleBluetoothController.getBleBluetooth(bleDevice);
        if (bleBluetooth == null) {
            BleLog.e("This device not connect!");
            return false;
        } else {
